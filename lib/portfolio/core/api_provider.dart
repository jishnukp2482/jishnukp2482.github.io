...
import 'package:potfolio/portfolio/core/pretty_printer.dart';
import 'package:potfolio/portfolio/data/remote/remote_routes/app_remote_routes.dart';
import 'package:potfolio/portfolio/presentation/routes/LocalStorageNames.dart';
import 'package:potfolio/portfolio/presentation/utilities/secure_storage.dart';
...
class ApiProvider {
  ...
  addToken() {
    String accesstoken =
        SecureStorage.read(LocalStorageKeys.accessTokenKEY) ?? "";
    String refreshtoken =
        SecureStorage.read(LocalStorageKeys.accessTokenKEY) ?? "";
